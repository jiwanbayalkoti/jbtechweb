...
<li class="breadcrumb-item"><a href="{{ route('admin.plan-requests.index') }}">Plan Requests</a></li>
...
<div class="mb-3">
    <a href="{{ route('admin.plan-requests.index') }}" class="btn btn-secondary btn-sm">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-9">{{ $planRequest->tenant->name ?? '-' }}</dd>
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                ...
                <form method="POST" action="{{ route('admin.plan-requests.approve', $planRequest) }}" class="mb-2">
                    @csrf
                ...
                @endif
                @if($invoice)
                <form method="POST" action="{{ route('admin.plan-requests.send-email', $planRequest) }}" class="mb-2">
                    @csrf
                ...
                <form method="POST" action="{{ route('admin.plan-requests.mark-read', $planRequest) }}">
                    @csrf
